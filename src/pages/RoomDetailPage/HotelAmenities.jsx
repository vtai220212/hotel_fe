...
import { AmenitiesContainer, AmenitiesTitle, AmenitiesList, AmenityItem, AmenityIcon } from './styles/HotelAmenitiesStyles';
...
const HotelAmenities = () => {
  // Hard-code danh sách tiện ích khách sạn với icon
  const hotelAmenities = [
